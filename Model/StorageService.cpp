...
std::optional<std::shared_ptr<TaskEntity>> StorageService::addSubTaskToParent(TaskEntity &parent, std::string taskName, time_t date,
...
std::optional<std::shared_ptr<TaskEntity>> StorageService::addSubTaskToParent(TaskEntity &parent, TaskEntity &task_entity) {
