...
class CoreAPIMock : public ClientInterface {
 public:
 ...
 public:
  ...
  MOCK_METHOD(std::optional<TaskDTO>, getTask,
              (
                  const TaskID &id
              ), (override));

  MOCK_METHOD(std::optional<std::vector<TaskDTO>>, getSubTasks,
              (
                  const TaskID &id
              ), (override));
 ...
 public:
  ...
  MOCK_METHOD(std::vector<TaskDTO>, showAllByPriority,
              (), (override));

  MOCK_METHOD(std::vector<TaskDTO>, showAllByLabel,
              (), (override));

  MOCK_METHOD(std::vector<TaskDTO>, showAllByDate,
              (), (override));

  MOCK_METHOD(std::vector<TaskDTO>, showTodayByPriority,
              (), (override));

  MOCK_METHOD(std::vector<TaskDTO>, showTodayByLabel,
              (), (override));
