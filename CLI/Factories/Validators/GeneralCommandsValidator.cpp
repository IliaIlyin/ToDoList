...
std::string GeneralCommandsValidator::interpretResult(GeneralCommandsValidator::CommandToken result) {
  switch (result) {
    case CommandToken::COMPLETE_TASK:
      return "Completing task";
    case CommandToken::DELETE_TASK:
      return "Deleting task";
    case CommandToken::GET_TASK:
      return "Getting task";
    case CommandToken::POSTPONE_TASK:
      return "Postponing task";
    case CommandToken::SHOW_DUE_DATE_SORT_PRIORITY:
      return "Showing all due date by priority";
    case CommandToken::SHOW_DUE_DATE_SORT_LABEL:
      return "Showing all due date by label in lex order";
    case CommandToken::SHOW_DUE_DATE_SORT_DATE:
      return "Showing all due date by date";
    case CommandToken::SHOW_TODAY_SORT_LABEL:
      return "Showing today by label";
    case CommandToken::SHOW_TODAY_SORT_PRIORITY:
      return "Showing today by priority";
    case CommandToken::SHOW_ALL_SORT_LABEL:
      return "Showing all by label";
    case CommandToken::SHOW_ALL_SORT_PRIORITY:
      return "Showing all by priority";
    case CommandToken::SHOW_ALL_SORT_DATE:
      return "Showing all by date";
    case CommandToken::ADD_SUBTASK:
      return "Adding subTask";
    case CommandToken::ADD_TASK:
      return "Adding task";
    case CommandToken::GET_SUBTASK:
      return "Getting subTasks";
    case CommandToken::INCORRECT_COMMAND:
      return "Incorrect input command";
    case CommandToken::EXIT:
      return "Exiting. Thanks for using!";
  }
}
