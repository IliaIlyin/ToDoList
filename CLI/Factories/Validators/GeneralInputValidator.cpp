...
std::string GeneralInputValidator::interpretResult(GeneralInputValidator::InputToken result) {
  switch(result){
    case InputToken::CORRECT:
      return "Correct input";
    case InputToken::INCORRECT_INPUT_DATE:
      return "Incorrect input date";
    case InputToken::INCORRECT_INPUT_ID:
      return "Incorrect input id";
    case InputToken::INCORRECT_INPUT_LABEL:
      return "Incorrect input label";
    case InputToken::INCORRECT_INPUT_NAME:
      return "Incorrect input task name";
    case InputToken::INCORRECT_INPUT_PRIORITY:
      return "Incorrect input priority";
    case InputToken::CANCEL_COMMAND:
