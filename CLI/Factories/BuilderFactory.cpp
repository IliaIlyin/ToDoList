...
std::shared_ptr<Builder> BuilderFactory::create(const GeneralCommandsValidator::CommandToken &token,
  ...
  switch (token) {
    case GeneralCommandsValidator::CommandToken::ADD_TASK:return BuildAddTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::ADD_SUBTASK:return BuildAddSubTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::DELETE_TASK:return BuildDeleteTaskCommandBuilder(creator);
    ...
    case GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_DATE:return BuildShowDueByDateCommandBuilder(creator);
    ...
    case GeneralCommandsValidator::CommandToken::COMPLETE_TASK:return BuildCompleteTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::POSTPONE_TASK:return BuildPostponeTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::GET_TASK:return BuildGetTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::GET_SUBTASK:return BuildGetSubTaskCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::SAVE:return BuildSaveCommandBuilder(creator);
    case GeneralCommandsValidator::CommandToken::LOAD:return BuildLoadCommandBuilder(creator);
...
std::shared_ptr<Builder> BuilderFactory::BuildLoadCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
  ...
  auto machine = creator->create(begin, context);
  return std::make_shared<LoadCommandBuilder>(std::move(machine));
}
std::shared_ptr<Builder> BuilderFactory::BuildSaveCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
  InputContext context;
  std::shared_ptr<LabelValidator> validator = std::make_shared<LabelValidator>();
  auto begin = std::make_shared<TaskLabelState>(validator,
                                                "Input file name or write cancel command to cancel command");
...
std::shared_ptr<Builder> BuilderFactory::BuildGetSubTaskCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
...
std::shared_ptr<Builder> BuilderFactory::BuildGetTaskCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
  std::shared_ptr<TaskIdValidator> validator = std::make_shared<TaskIdValidator>();
  auto begin = std::make_shared<TaskIdState<ExitState, ExitValidator>>(validator);
  InputContext context;
  auto machine = creator->create(begin, context);
...
std::shared_ptr<Builder> BuilderFactory::BuildPostponeTaskCommandBuilder(std::shared_ptr<
    InputStateMachineCreatorInterface> &creator) const {
  InputContext context;
  std::shared_ptr<TaskIdValidator> validator = std::make_shared<TaskIdValidator>();
...
std::shared_ptr<Builder> BuilderFactory::BuildDeleteTaskCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
  std::shared_ptr<TaskIdValidator> validator = std::make_shared<TaskIdValidator>();
  InputContext context;
  auto begin = std::make_shared<TaskIdState<ExitState, ExitValidator>>(validator);
  auto machine = creator->create(begin, context);
...
std::shared_ptr<Builder> BuilderFactory::BuildAddSubTaskCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
...
std::shared_ptr<Builder> BuilderFactory::BuildAddTaskCommandBuilder(std::shared_ptr<InputStateMachineCreatorInterface> &creator) const {
