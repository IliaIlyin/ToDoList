...
#ifndef TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYLABELCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYLABELCOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Show/ShowDueDate/ShowDueDateByLabelCommand.h"
#include "Contexts/Context.h"


class ShowDueDateByLabelCommandVisitor  : public Visitor {
 ...
 public:
  ...
  ShowDueDateByLabelCommandVisitor(const std::shared_ptr<Context> &context);
 private:
  std::shared_ptr<Context> context_;
};

#endif //TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYLABELCOMMANDVISITOR_H_
