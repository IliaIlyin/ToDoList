...
#ifndef TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYDATECOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYDATECOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Show/ShowDueDate/ShowDueDateByDateCommand.h"
#include "Contexts/Context.h"

class ShowDueDateByDateCommandVisitor : public Visitor {
 public:
  ShowDueDateByDateCommandVisitor(const std::shared_ptr<Context> &context);
 public:
...
#endif //TODOLIST_CLI_VISITORS_SHOW_SHOWDUEDATE_SHOWDUEDATEBYDATECOMMANDVISITOR_H_
