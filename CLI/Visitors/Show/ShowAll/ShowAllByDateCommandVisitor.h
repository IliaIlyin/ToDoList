...
#ifndef TODOLIST_CLI_VISITORS_SHOW_SHOWALL_SHOWALLBYDATECOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SHOW_SHOWALL_SHOWALLBYDATECOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Show/ShowAll/ShowAllByDateCommand.h"
#include "Contexts/Context.h"
class ShowAllByDateCommandVisitor : public Visitor {
 ...
 public:
  ...
  ShowAllByDateCommandVisitor(const std::shared_ptr<Context> &context);
 private:
  std::shared_ptr<Context> context_;
};

#endif //TODOLIST_CLI_VISITORS_SHOW_SHOWALL_SHOWALLBYDATECOMMANDVISITOR_H_
