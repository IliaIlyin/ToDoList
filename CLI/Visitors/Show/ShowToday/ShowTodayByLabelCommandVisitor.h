...
#ifndef TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYLABELCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYLABELCOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Show/ShowToday/ShowTodayByLabelCommand.h"
#include "Contexts/Context.h"

class ShowTodayByLabelCommandVisitor  : public Visitor {
 public:
 ...
 public:
  ...
  ShowTodayByLabelCommandVisitor(const std::shared_ptr<Context> &context);
 private:
  std::shared_ptr<Context> context_;
};

#endif //TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYLABELCOMMANDVISITOR_H_
