...
#ifndef TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYPRIORITYCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYPRIORITYCOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Show/ShowToday/ShowTodayByPriorityCommand.h"
#include "Contexts/Context.h"

class ShowTodayByPriorityCommandVisitor  : public Visitor {
 public:
 ...
 public:
  ...
  ShowTodayByPriorityCommandVisitor(const std::shared_ptr<Context> &context);
 private:
  std::shared_ptr<Context> context_;
};

#endif //TODOLIST_CLI_VISITORS_SHOW_SHOWTODAY_SHOWTODAYBYPRIORITYCOMMANDVISITOR_H_
