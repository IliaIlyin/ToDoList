...
#ifndef TODOLIST_CLI_VISITORS_ADDCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_ADDCOMMANDVISITOR_H_

#include "Visitor.h"

class AddTaskCommandVisitor : public Visitor {

 public:
  bool visitAddTaskCommand(AddTaskCommand &command) override;
  bool visitAddSubTaskCommand(AddSubTaskCommand &command) override;
...
#endif //TODOLIST_CLI_VISITORS_ADDCOMMANDVISITOR_H_
