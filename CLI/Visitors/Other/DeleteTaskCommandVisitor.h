...
#ifndef TODOLIST_CLI_VISITORS_OTHER_DELETETASKCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_OTHER_DELETETASKCOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Other/DeleteTaskCommand.h"
class DeleteTaskCommandVisitor : public Visitor {
 public:
