...
#ifndef TODOLIST_CLI_VISITORS_SERIALIZE_LOADCOMMANDVISITOR_H_
#define TODOLIST_CLI_VISITORS_SERIALIZE_LOADCOMMANDVISITOR_H_
#include "Visitor.h"
#include "Commands/Serialize/LoadCommand.h"

class LoadCommandVisitor : public Visitor {
 public:
 ...
 public:
  ...
  LoadCommandVisitor(const std::shared_ptr<IOStreamInterface> &outputer);
 private:
  std::shared_ptr<IOStreamInterface> outputer_;
};
#endif //TODOLIST_CLI_VISITORS_SERIALIZE_LOADCOMMANDVISITOR_H_
