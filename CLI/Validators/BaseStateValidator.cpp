...
GeneralCommandsValidator::CommandToken BaseStateValidator::validate(const std::string &s) {
  ...
  if(GeneralCommandsValidator::validateShowDueDate(s)==GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_DATE)
    return GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_DATE;
  if(GeneralCommandsValidator::validateShowDueDate(s)==GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_LABEL)
    return GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_LABEL;
  if(GeneralCommandsValidator::validateShowDueDate(s)==GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_PRIORITY)
    return GeneralCommandsValidator::CommandToken::SHOW_DUE_DATE_SORT_PRIORITY;
  if(GeneralCommandsValidator::validateShowToday(s)==GeneralCommandsValidator::CommandToken::SHOW_TODAY_SORT_PRIORITY)
